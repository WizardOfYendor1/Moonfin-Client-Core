...
class UserPreferences extends ChangeNotifier {
  ...
  /// Last Live TV channel watched on this server/account. This is navigation
  /// state rather than a server setting, but it still needs the same scope as
  /// channel IDs so another server cannot claim the value.
